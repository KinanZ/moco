...
python3 /misc/student/alzouabk/Thesis/self_supervised_pretraining/moco/main_lincls.py \
  ...
  --lr 0.0005 \
  --batch-size 48 \
  --pretrained /misc/student/alzouabk/Thesis/supervised_multi_label_classification/outputs_final/supervised_MLC_affine_h_ED_s_%_resnet_18/model.pth \
