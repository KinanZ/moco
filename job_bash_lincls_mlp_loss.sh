#PBS -N moco_lincl_RN18_005625_loss
#PBS -S /bin/bash
...
python3 /misc/student/alzouabk/Thesis/self_supervised_pretraining/moco/main_lincls.py \
  --exp 'moco_lincl_RN18_005625_loss' \
  --epochs 40 \
  --print-freq 1 \
  --optimizer adam \
  --arch resnet18 \
  --lr 0.1 \
  --batch-size 48 \
  --pretrained /misc/student/alzouabk/Thesis/self_supervised_pretraining/moco/outputs_2/RN18_005625/best_model_loss.pth.tar \
