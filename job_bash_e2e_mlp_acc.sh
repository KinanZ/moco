#PBS -N moco_e2e_mlp_RN50_cos_01_acc
#PBS -S /bin/bash
...
python3 /misc/student/alzouabk/Thesis/self_supervised_pretraining/moco/main_lincls.py \
  --exp 'moco_e2e_mlp_RN50_cos_01_acc' \
  --epochs 40 \
  --e2e \
  --optimizer adam \
  --print-freq 1 \
  ...
  --lr 0.001 \
  --batch-size 46 \
  --pretrained /misc/student/alzouabk/Thesis/self_supervised_pretraining/moco/outputs_2/RN50_cos_01/best_model_acc.pth.tar \
