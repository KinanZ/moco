#PBS -N moco_lincls_all_upgraded_no_cos
#PBS -S /bin/bash
...
python3 /misc/student/alzouabk/Thesis/self_supervised_pretraining/moco/main_lincls.py \
  --exp 'bestAug_lincls_all_upgraded_no_cos' \
  --epochs 40 \
  --print-freq 1 \
  --arch resnet50 \
  --num_channels 3 \
  --lr 0.0375 \
  --batch-size 32 \
  --pretrained /misc/student/alzouabk/Thesis/self_supervised_pretraining/moco/outputs/3c_v2_bestAug_all_upgraded_no_cos/best_model.pth.tar \
