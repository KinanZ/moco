#PBS -N moco_e2e_mlp_RN18_001_loss
#PBS -S /bin/bash
...
python3 /misc/student/alzouabk/Thesis/self_supervised_pretraining/moco/main_lincls.py \
  --exp 'moco_e2e_mlp_RN18_001_loss' \
  --epochs 40 \
  --e2e \
  --optimizer adam \
  --print-freq 1 \
  ...
  --lr 0.001 \
  --batch-size 48 \
  --pretrained /misc/student/alzouabk/Thesis/self_supervised_pretraining/moco/outputs_2/mlp_RN18_001/best_model_loss.pth.tar \
